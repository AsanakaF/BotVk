                ...
                if messages["count"] >= 1:
                    ...
                    if body.lower() == "привет":
                        ...
                        self.vk.method("messages.send", {"peer_id": id, "message": "Портрет (200 р) \n"
                                                                                   "По пояс (500 р) \n"
                                                                                   "В полный рост (700 р) \n"
                                                                                   "Чтобы выбрать нажми на 'Портрет'/'По пояс'/'В полный рост'",
                                                         "keyboard": keyboard})
                    elif body.lower() == "портрет":
                        self.vk.method("messages.send", {"peer_id": id,
                                                         "message": "Вы заказали портрет. Стоимость 200 рублей. Дождитесь пока я свяжусь с вами."})
                        ...
                        self.vk.method("messages.send", {"peer_id": id,
                                                         "message": "Вы заказали арт по пояс. Стоимость 500 рублей. Дождитесь пока я свяжусь с вами."})
                        from Bot import VkBot
                        bot = VkBot()
                        bot.bot()
                    elif body.lower() == "в полный рост":
                        self.vk.method("messages.send", {"peer_id": id,
                                                         "message": "Вы заказали арт в полный рост. Стоимость 700 рублей. Дождитесь пока я свяжусь с вами."})
                        from Bot import VkBot
                        bot = VkBot()
                        bot.bot()
                    else:
                        self.vk.method("messages.send",
                                       {"peer_id": id, "message": "Я вас не понимаю. Напишите 'привет' или 'команды'"})
